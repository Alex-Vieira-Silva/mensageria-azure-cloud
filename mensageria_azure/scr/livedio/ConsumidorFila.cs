    ...
    public class ConsumidorFila : BackgroundService
    {
        ...
        public ConsumidorFila()
        {
            _client = new QueueClient(
                "Endpoint=sb://inforpoint.servicebus.windows.net/;SharedAccessKeyName=inforpointcheck;SharedAccessKey=BC/50mKdBZ0WW/ZdNPXi11/cbYJ6F/CMfPidxmOPvv8=;EntityPath=fila1",
                "fila1",
